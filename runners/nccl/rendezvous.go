...
//     matching parameters; mismatch them and the run
...
// phaseCollective is the only phase this runner has: nccl_pair sweeps every
// message size inside one communicator, because tearing a communicator down and
// rebuilding it per size would measure NCCL's initialisation as often as its
// bandwidth.
const phaseCollective = "collective"
