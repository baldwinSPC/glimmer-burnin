...
func TestUnitOf(t *testing.T) {
	cases := []struct {
		...
		{"soakConnectFailures", UnitNone},
		{"soakConnectRetries", UnitNone},
		...
		{"retentionBitFlips", UnitNone},
		{"retentionBytesFlipped", UnitNone},
		{"retentionPatternsCompleted", UnitNone},
		{"retentionFirstFlipOffset", UnitNone},
		{"retentionFirstFlipPattern", UnitNone},
		{"retentionMemoryLocked", UnitNone},
...
func TestRegistryContainsTheNamesConsumersDependOn(t *testing.T) {
	want := map[string]struct {
		...
		"memClockPct":                {UnitPercent, ThresholdUseEvidence},
		...
		"ratedMemClockMHz":           {UnitMegahertz, ThresholdUseEvidence},
		...
		"retentionBitFlips":          {UnitNone, ThresholdUseAcceptance},
		"retentionBytesFlipped":      {UnitNone, ThresholdUseAcceptance},
		"retentionPatternsCompleted": {UnitNone, ThresholdUseEvidence},
		"retentionFirstFlipOffset":   {UnitNone, ThresholdUseEvidence},
		"retentionFirstFlipPattern":  {UnitNone, ThresholdUseEvidence},
		"retentionMemoryLocked":      {UnitNone, ThresholdUseEvidence},
		...
		"soakConnectFailures":        {UnitNone, ThresholdUseAcceptance},
		"soakConnectRetries":         {UnitNone, ThresholdUseEvidence},
		...
		// power-swing.
		"swingTransitions":           {UnitNone, ThresholdUseEvidence},
		"swingWorstPostRampClockPct": {UnitPercent, ThresholdUseEvidence},
		"swingPeakRampPowerW":        {UnitWatts, ThresholdUseEvidence},
		"swingNewThrottleEvents":     {UnitNone, ThresholdUseEvidence},
		"swingNewThrottleReasons":    {UnitNone, ThresholdUseEvidence},
...
func TestAggregationOfTheEasilyMistakenMetrics(t *testing.T) {
	cases := map[string]struct {
		...
		"soakConnectFailures":  {AggSum, "windows refused at the control port, summed across segments"},
		"soakConnectRetries":   {AggSum, "refused attempts a later try recovered, summed across segments"},
